...
const Dashboard = () => {
  ...
  const { schools, invoices, collections, loading, error } = useSelector(state => ({
    schools: state.schools.schools,
    invoices: state.invoices.invoices,
    collections: state.collections.collections,
    loading: state.collections.loading || state.schools.loading || state.invoices.loading,
    error: state.collections.error || state.schools.error || state.invoices.error
  }));
    ...
    <Layout>
      <section className={styles.container}>
        <div className="top-card-metrics">
          <TopCardMetrics schools={schools} collections={collections} invoices={invoices} />
        </div>
