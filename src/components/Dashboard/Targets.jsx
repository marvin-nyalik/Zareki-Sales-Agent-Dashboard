    ...
    <>
      ...
      <div className={isMobile ? styles['mobile-cont'] : styles.container}>
        ...
        <div className="pie-div flex flex-col justify-center">
          ...
          <PieChartComponent target={analytics_target} progress={achieved_targets['Zeraki Analytics'] || 0} />
        </div>

        <div className="pie-div flex flex-col justify-center">
          <p className='text-center font-semibold'>Zeraki Finance</p>
          <PieChartComponent target={finance_target} progress={achieved_targets['Zeraki Finance'] || 0} />
        </div>

        <div className="pie-div flex flex-col justify-center">
          <p className='text-center font-semibold'>Zeraki Timetable</p>
          <PieChartComponent target={timetable_target} progress={achieved_targets['Zeraki Timetable'] || 0} />
        </div>
